		...
		/*canvas.addListener(new Canvas.CanvasMouseUpListener() {
			...
			public void mouseUp(Point p) {
				getWindow().showNotification(
						"Mouse released at (" + p.getX() + "," + p.getY() + ")");
			}
		});
...
//		canvas.translate(0, 0);
	...
	private void drawStep(){
		...
		rect.setColor("#528200");
		rect.setFillColor("#008231");
		rect.setBorderWidth(4);
		rect.draw(canvas);
//		rect = new Rect(new Point(450, 550), new Point(425, 525));
//		rect.draw(canvas);
//		rect = new Rect(new Point(600, 600), new Point(700, 700));
//		rect.setColor("#5282ff");
//		rect.setFillColor("#008231");
